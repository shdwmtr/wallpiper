...
pub(crate) type PfnGetSemaphoreFdKhr =
    unsafe extern "C" fn(vk::Device, *const vk::SemaphoreGetFdInfoKHR, *mut i32) -> vk::Result;
...
pub(crate) struct DeviceProcTable {
    ...
    pub get_semaphore_fd_khr: PfnGetSemaphoreFdKhr,
...
impl DeviceProcTable {
    pub(crate) unsafe fn load(
        ...
        Self {
            ...
            get_semaphore_fd_khr: load_fn(get_proc_addr, device, c"vkGetSemaphoreFdKHR"),
